...
function makePersonObject(idArgu, nameArgu, emailArgu) {
  let Obj = {
    id: idArgu,
    name: nameArgu,
    email: emailArgu,
...
console.log(makePersonObject(3, "broman", "bruh@SpeechGrammarList.com"));
...
console.log(getName({ id: 1, name: 'Thalnos', email: 'leia@leia.com' }));
...
*/
function getOlderCars(inventory, yearNum) {
  let olderCars = [];
  for (let i = 0; i < inventory.length; i++) {
    if (inventory[i].car_year <= yearNum) {
